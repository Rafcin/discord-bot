...
const Schema: z.ZodType<Prisma.FeatureCreateOrConnectWithoutConfigurationsInput> =
  z
    .object({
...
export const FeatureCreateOrConnectWithoutConfigurationsInputObjectSchema =
  Schema
