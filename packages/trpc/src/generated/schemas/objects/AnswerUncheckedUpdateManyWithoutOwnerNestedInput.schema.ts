  ...
  z
    .object({
      ...
      upsert: z
        .union([
          z.lazy(
            () => AnswerUpsertWithWhereUniqueWithoutOwnerInputObjectSchema
          ),
          z
            .lazy(
              () => AnswerUpsertWithWhereUniqueWithoutOwnerInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => AnswerUpdateWithWhereUniqueWithoutOwnerInputObjectSchema
          ),
          z
            .lazy(
              () => AnswerUpdateWithWhereUniqueWithoutOwnerInputObjectSchema
      ...
      updateMany: z
        .union([
          ...
          z
            .lazy(() => AnswerUpdateManyWithWhereWithoutOwnerInputObjectSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
...
export const AnswerUncheckedUpdateManyWithoutOwnerNestedInputObjectSchema =
  Schema
