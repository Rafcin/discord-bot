  ...
  z
    .object({
      ...
      upsert: z
        .union([
          z.lazy(
            () => QuestionUpsertWithWhereUniqueWithoutGuildInputObjectSchema
          ),
          z
            .lazy(
              () => QuestionUpsertWithWhereUniqueWithoutGuildInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => QuestionUpdateWithWhereUniqueWithoutGuildInputObjectSchema
          ),
          z
            .lazy(
              () => QuestionUpdateWithWhereUniqueWithoutGuildInputObjectSchema
      ...
      updateMany: z
        .union([
          z.lazy(
            () => QuestionUpdateManyWithWhereWithoutGuildInputObjectSchema
          ),
          z
            .lazy(
              () => QuestionUpdateManyWithWhereWithoutGuildInputObjectSchema
...
export const QuestionUncheckedUpdateManyWithoutGuildNestedInputObjectSchema =
  Schema
