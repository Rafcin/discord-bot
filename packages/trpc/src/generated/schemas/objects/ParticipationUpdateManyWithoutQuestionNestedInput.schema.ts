...
const Schema: z.ZodType<Prisma.ParticipationUpdateManyWithoutQuestionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ParticipationUpdateManyWithoutQuestionNestedInputObjectSchema =
  Schema
