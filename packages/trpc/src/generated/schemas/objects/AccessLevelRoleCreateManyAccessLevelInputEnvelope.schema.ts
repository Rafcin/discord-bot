...
const Schema: z.ZodType<Prisma.AccessLevelRoleCreateManyAccessLevelInputEnvelope> =
  z
    .object({
      data: z
...
export const AccessLevelRoleCreateManyAccessLevelInputEnvelopeObjectSchema =
  Schema
