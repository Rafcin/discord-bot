...
const Schema: z.ZodType<Prisma.ParticipationUncheckedCreateWithoutQuestionInput> =
  z
    .object({
...
export const ParticipationUncheckedCreateWithoutQuestionInputObjectSchema =
  Schema
