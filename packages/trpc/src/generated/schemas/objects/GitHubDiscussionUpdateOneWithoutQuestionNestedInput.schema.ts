...
const Schema: z.ZodType<Prisma.GitHubDiscussionUpdateOneWithoutQuestionNestedInput> =
  z
    .object({
      ...
      connectOrCreate: z
        .lazy(
          () => GitHubDiscussionCreateOrConnectWithoutQuestionInputObjectSchema
        )
        .optional(),
      upsert: z
      ...
      connect: z
        .lazy(() => GitHubDiscussionWhereUniqueInputObjectSchema)
        .optional(),
      update: z
        .union([
...
export const GitHubDiscussionUpdateOneWithoutQuestionNestedInputObjectSchema =
  Schema
