...
const Schema: z.ZodType<Prisma.FeatureUncheckedUpdateWithoutConfigurationsInput> =
  z
    .object({
      code: z
        .union([
...
export const FeatureUncheckedUpdateWithoutConfigurationsInputObjectSchema =
  Schema
