...
const Schema: z.ZodType<Prisma.ParticipationUncheckedUpdateWithoutQuestionInput> =
  z
    .object({
      id: z
        .union([
...
export const ParticipationUncheckedUpdateWithoutQuestionInputObjectSchema =
  Schema
