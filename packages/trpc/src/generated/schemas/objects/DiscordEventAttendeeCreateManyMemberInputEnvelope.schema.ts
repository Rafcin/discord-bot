...
const Schema: z.ZodType<Prisma.DiscordEventAttendeeCreateManyMemberInputEnvelope> =
  z
    .object({
      data: z
...
export const DiscordEventAttendeeCreateManyMemberInputEnvelopeObjectSchema =
  Schema
