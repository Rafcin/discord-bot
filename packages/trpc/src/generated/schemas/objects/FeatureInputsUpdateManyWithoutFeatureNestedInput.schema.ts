...
const Schema: z.ZodType<Prisma.FeatureInputsUpdateManyWithoutFeatureNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FeatureInputsUpdateManyWithoutFeatureNestedInputObjectSchema =
  Schema
