...
const Schema: z.ZodType<Prisma.ConfigurationUncheckedUpdateWithoutFeaturesInput> =
  z
    .object({
      id: z
        .union([
...
export const ConfigurationUncheckedUpdateWithoutFeaturesInputObjectSchema =
  Schema
