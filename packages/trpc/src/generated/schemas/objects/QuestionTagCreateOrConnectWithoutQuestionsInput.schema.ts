...
const Schema: z.ZodType<Prisma.QuestionTagCreateOrConnectWithoutQuestionsInput> =
  z
    .object({
      ...
      create: z.union([
        ...
        z.lazy(
          () => QuestionTagUncheckedCreateWithoutQuestionsInputObjectSchema
        ),
      ]),
    })
    .strict()

export const QuestionTagCreateOrConnectWithoutQuestionsInputObjectSchema =
  Schema
