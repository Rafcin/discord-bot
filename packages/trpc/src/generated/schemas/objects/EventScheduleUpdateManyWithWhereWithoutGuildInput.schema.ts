...
const Schema: z.ZodType<Prisma.EventScheduleUpdateManyWithWhereWithoutGuildInput> =
  z
    .object({
...
export const EventScheduleUpdateManyWithWhereWithoutGuildInputObjectSchema =
  Schema
