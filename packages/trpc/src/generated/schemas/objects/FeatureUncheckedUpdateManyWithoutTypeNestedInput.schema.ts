...
const Schema: z.ZodType<Prisma.FeatureUncheckedUpdateManyWithoutTypeNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => FeatureUpsertWithWhereUniqueWithoutTypeInputObjectSchema
          ),
          z
            .lazy(
              () => FeatureUpsertWithWhereUniqueWithoutTypeInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => FeatureUpdateWithWhereUniqueWithoutTypeInputObjectSchema
          ),
          z
            .lazy(
              () => FeatureUpdateWithWhereUniqueWithoutTypeInputObjectSchema
      ...
      updateMany: z
        .union([
          ...
          z
            .lazy(() => FeatureUpdateManyWithWhereWithoutTypeInputObjectSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
...
export const FeatureUncheckedUpdateManyWithoutTypeNestedInputObjectSchema =
  Schema
