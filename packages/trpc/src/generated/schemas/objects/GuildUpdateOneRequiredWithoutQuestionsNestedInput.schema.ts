...
const Schema: z.ZodType<Prisma.GuildUpdateOneRequiredWithoutQuestionsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        ...
        .optional(),
      upsert: z
        .lazy(() => GuildUpsertWithoutQuestionsInputObjectSchema)
        .optional(),
...
export const GuildUpdateOneRequiredWithoutQuestionsNestedInputObjectSchema =
  Schema
