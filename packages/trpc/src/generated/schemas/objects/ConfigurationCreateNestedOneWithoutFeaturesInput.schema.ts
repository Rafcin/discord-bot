...
const Schema: z.ZodType<Prisma.ConfigurationCreateNestedOneWithoutFeaturesInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        .lazy(
          () => ConfigurationCreateOrConnectWithoutFeaturesInputObjectSchema
        )
        .optional(),
      connect: z
...
export const ConfigurationCreateNestedOneWithoutFeaturesInputObjectSchema =
  Schema
