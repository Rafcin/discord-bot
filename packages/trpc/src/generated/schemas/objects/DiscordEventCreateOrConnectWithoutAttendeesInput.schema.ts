...
const Schema: z.ZodType<Prisma.DiscordEventCreateOrConnectWithoutAttendeesInput> =
  z
    .object({
...
export const DiscordEventCreateOrConnectWithoutAttendeesInputObjectSchema =
  Schema
