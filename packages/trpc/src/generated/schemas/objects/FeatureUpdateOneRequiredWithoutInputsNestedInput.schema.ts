...
const Schema: z.ZodType<Prisma.FeatureUpdateOneRequiredWithoutInputsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        ...
        .optional(),
      upsert: z
        .lazy(() => FeatureUpsertWithoutInputsInputObjectSchema)
        .optional(),
...
export const FeatureUpdateOneRequiredWithoutInputsNestedInputObjectSchema =
  Schema
