...
const Schema: z.ZodType<Prisma.DiscordUserCreateWithoutCreatedSchedulesInput> =
  z
    .object({
      id: z.string(),
      account: z
      ...
      participations: z
        .lazy(
          () => ParticipationCreateNestedManyWithoutParticipantInputObjectSchema
        )
        .optional(),
      answers: z
      ...
      createdEvents: z
        .lazy(
          () => DiscordEventCreateNestedManyWithoutCreatedByInputObjectSchema
        )
        .optional(),
    })
    .strict()
