...
const Schema: z.ZodType<Prisma.EventScheduleUncheckedUpdateWithoutCreatedByInput> =
  z
    .object({
      id: z
        .union([
...
export const EventScheduleUncheckedUpdateWithoutCreatedByInputObjectSchema =
  Schema
