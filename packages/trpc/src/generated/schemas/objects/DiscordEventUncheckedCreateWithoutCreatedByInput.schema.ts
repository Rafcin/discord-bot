...
const Schema: z.ZodType<Prisma.DiscordEventUncheckedCreateWithoutCreatedByInput> =
  z
    .object({
      id: z.string(),
      title: z.string(),
...
export const DiscordEventUncheckedCreateWithoutCreatedByInputObjectSchema =
  Schema
