...
const Schema: z.ZodType<Prisma.ConfigurationUncheckedCreateWithoutFeaturesInput> =
  z
    .object({
      id: z.string(),
...
export const ConfigurationUncheckedCreateWithoutFeaturesInputObjectSchema =
  Schema
